  ...
  <div class="navbar-vertical-content-wrapper" 
    ...
    <div class="navbar-vertical-content flex-grow-1" 
      ...
      <ul class="navbar-nav flex-column">
        ...
        {{-- Pengumuman --}}
        <li class="nav-item">
          <a class="nav-link {{ request()->routeIs('backend.announcements.index') ? 'active' : '' }}" href="{{ route('backend.announcements.index') }}">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        {{-- Kontak & Hubungi Kami --}}
        <li class="nav-item">
          <a class="nav-link {{ request()->routeIs('backend.kontak.index') ? 'active' : '' }}" href="{{ route('backend.kontak.index') }}">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        {{-- ================= PROGRAM / JURUSAN ================= --}}
        <li class="nav-item">
          <a class="nav-link {{ request()->routeIs('backend.majors.*') ? 'active' : '' }}"
            href="{{ route('backend.majors.index') }}">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
