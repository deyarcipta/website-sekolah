        ...
        <div class="row text-start align-items-start">
            ...
            <div class="col-md-4 mb-4">
                ...
                <div class="d-flex gap-2">
                    <a href="#"><img src="{{ asset('assets/img/instagram.png') }}" width="50" alt="Facebook"></a>
                    <a href="#"><img src="{{ asset('assets/img/youtube.png') }}" width="50" alt="Twitter"></a>
                    <a href="#"><img src="{{ asset('assets/img/facebook.png') }}" width="50" alt="YouTube"></a>
                    <a href="#"><img src="{{ asset('assets/img/tiktok.png') }}" width="50" alt="Instagram"></a>
                </div>
            </div>
        </div>
    </div>
