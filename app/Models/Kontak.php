...
class Kontak extends Model
{
    ...
    public function getStaff1ImageUrlAttribute()
    {
        return $this->staff1_image ? 
            asset('storage/' . $this->staff1_image) : 
            asset('assets/img/foto-guru.png');
    }

    public function getStaff2ImageUrlAttribute()
    {
        return $this->staff2_image ? 
            asset('storage/' . $this->staff2_image) : 
            asset('assets/img/foto-guru.png');
    }

    public function getContactImageUrlAttribute()
    {
        return $this->contact_image ? 
            asset('storage/' . $this->contact_image) : 
            asset('assets/img/gambar-kontak.png');
    }

    // Helper untuk mendapatkan satu record
    public static function getData()
    {
        ...
        if (!$data) {
            $data = self::create([
                ...
                'map_embed_url' => 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3965.6338566938543!2d106.83336617402644!3d-6.31173736176519!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69edee70aeb597%3A0x3c33aa85fd86d917!2sSMK%20WISATA%20INDONESIA!5e0!3m2!1sid!2sid!4v1760179549082!5m2!1sid!2sid',
